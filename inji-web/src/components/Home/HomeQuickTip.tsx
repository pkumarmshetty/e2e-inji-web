...
export const HomeQuickTip: React.FC<HomeQuickTipProps> = (props) => {
    ...
    return (
        <div data-testid="HomeQuickTip-Container" className="py-2 mb-5 pb-5">
          <div data-testid="HomeQuickTip-Content" className="flex flex-col sm:flex-row items-center mx-[4%] sm:mb-3 py-[5%] sm:py-[2%] px-[1%] rounded-xl bg-gradient-to-r from-[--iw-color-primary] to-[--iw-color-secondary] sm:w-[91%] sm:ml-auto sm:mr-auto">
